...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<LightningSummonerBlockEntity>> ItemDisplayerEntity =
            BLOCK_ENTITIES.register("item_displayer_block_entity",
                    () -> BlockEntityType.Builder.of(LightningSummonerBlockEntity::new, ModBlocks.ItemDisplayerBlock.get()).build(null));
